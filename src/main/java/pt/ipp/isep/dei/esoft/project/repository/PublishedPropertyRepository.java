...
public class PublishedPropertyRepository {
    ...
    public Optional<Property> getProperties(String filter) {

        Optional<Property> returnProperties = Optional.empty();

        //Não esquecer de implementar
//        for (Property property : properties) {
//            if (property.hasFilter(filter)) {
//                returnProperties = Optional.of(property);
//            }
//        }
