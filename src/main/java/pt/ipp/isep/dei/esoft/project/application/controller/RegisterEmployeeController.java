...
public class RegisterEmployeeController {
    ...
    public RegisterEmployeeController(PublishedPropertyRepository publishedPropertyRepository, AuthenticationRepository authenticationRepository) {
        this.employeeRepository = publishedPropertyRepository;
    }

    private PublishedPropertyRepository getPublishedPropertiesRepository() {
        if (employeeRepository == null) {
            Repositories repositories = Repositories.getInstance();
            employeeRepository = repositories.getPublishedPropertyRepository();
        }
