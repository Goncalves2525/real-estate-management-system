...
> **Question:** When the store manager selects simple-linear regression to analyse the deals, does he also select one of the specified relevant parameters to serve as the [in]dependent variable in the regression model?
>
...
* Selected data:
  ...
  * Type of statistic to be calculated (confidence interval, hypothesis test, etc.)
...
![System Sequence Diagram - Alternative One](svg/us018-system-sequence-diagram.svg)
