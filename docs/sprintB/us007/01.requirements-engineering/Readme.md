...
As an unregistered person, I want to register in the system to buy, sell or rent
properties.
...
> **Question:** It was previously stated that an unregistered person could do a property listing request. However, with the introduction of US007, I want to clarify and make sure that now a person needs to be registered in order to buy, sell or rent properties, or if they can still do it unregistered.
>  
...
> **Question:** When an unregistered person wants to register a new account in the system, the set of parameters that are asked are the following: name, citizen card number, tax number, email, phone number, and password. Do you want any extra parameters/requirements to be asked or just the ones specified above? If so, which ones are mandatory?
> 
...
* **AC2:** The confirmation email must be sent to the person.
* **AC3:** The confirmation email must be accepted by the person in order to complete the registration.
