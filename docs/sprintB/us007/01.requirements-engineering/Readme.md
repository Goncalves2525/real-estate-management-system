...
* **AC2:** The confirmation email must be sent to the user.
* **AC3:** The confirmation email must be accepted by the user in order to complete the registration.


### 1.4. Found out Dependencies


* There is a dependency to "US 003 - As a system administrator, I want to register a new employee" since an agent and a user are the same thing.
