...
**Test 1:** Checks that when a person doesn't choose filters nor sort criteria, a list of all properties sorted by default criteria (most recently added) is returned - AC5.
...
**Test 2:** Checks that when a person only choses to sort, the list of properties is correctly ordered - AC2 and AC4. 
...
**Test 4:** Checks that when a person only choses to filter, the list of properties is correctly filtered  - AC1 and AC3. 
...
**Test 6:** Checks that when a person choses to filter and sort, the list of properties is correctly filtered and sorted - AC1, AC2 and AC4. 
